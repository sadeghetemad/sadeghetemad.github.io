...
class TwitterFetcher {
  ...
  renderFallbackTweets() {
    const fallbackTweets = [
      {
        id: "1",
        text: "Just released a new version of rust_decision_tree with 2x performance improvement on large datasets. Check it out! #MachineLearning #Rust github.com/sadeghetemad/rust_decision_tree",
        date: "March 25, 2025",
        likes: 42,
        retweets: 18
      },
      ...
      {
        id: "4",
        text: "New blog post: 'Building High-Performance Decision Trees in Rust' - medium.com/@sadeghetemad.aydin/rust-trees #Rust #MachineLearning #Performance",
        date: "March 10, 2025",
        likes: 56,
        retweets: 23
      },
      {
        id: "5",
        text: "Just pushed updates to the  implementation - now with better handling of categorical variables and parallelized training. #ML #DecisionTrees",
        date: "March 5, 2025",
        likes: 31,
        retweets: 12
      }
          ...
          <div class="flex items-start mb-4">
            ...
            <div class="flex-1">
              <div class="flex items-center">
                <h4 class="font-bold text-gray-900 dark:text-white">Sadegh Etemad</h4>
                <span class="ml-2 text-gray-500 dark:text-gray-400 text-sm">@sadeghetemad.aydin</span>
              </div>
    ...
    const apiNoteHtml = `
      <div class="col-span-full text-center mb-6 bg-blue-50 dark:bg-blue-900/30 p-4 rounded-lg">
        <p class="text-sm text-gray-600 dark:text-gray-400">
          ...
          <a href="https://x.com/sadeghetemad.aydin" target="_blank" rel="noopener noreferrer" class="text-blue-600 dark:text-blue-400 hover:underline ml-1">
...
document.addEventListener('DOMContentLoaded', () => {
  const twitterFetcher = new TwitterFetcher('sadeghetemad.aydin', 'twitter-posts-container');
  twitterFetcher.init();
